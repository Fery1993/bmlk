<x-app-layout title="Vendor Baru" breadcrumb="Tambah data vendor">

<x-form-card title="Form Vendor Baru" :backRoute="route('master.vendors.index')">
...
<form method="POST" action="{{ route('master.vendors.store') }}">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="kode" value="{{ old('kode') }}" required placeholder="cth. VEND-0001"
