<x-app-layout title="Customer Baru" breadcrumb="Tambah data customer">

<x-form-card title="Form Customer Baru" :backRoute="route('master.customers.index')">
...
<form method="POST" action="{{ route('master.customers.store') }}">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="kode" value="{{ old('kode') }}" required placeholder="cth. CUST-0001"
        ...
        <div class="col-span-2">
            ...
            <textarea name="alamat" rows="2" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">{{ old('alamat') }}</textarea>
