<x-app-layout title="Edit Karyawan" breadcrumb="Ubah data karyawan {{ $karyawan->nik }}">

<x-form-card title="Form Edit Karyawan" :backRoute="route('master.karyawan.index')">

<form method="POST" action="{{ route('master.karyawan.update', $karyawan) }}">
    @csrf
    @method('PUT')
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div class="col-span-2">
            ...
            <input type="text" name="rekening_bank" value="{{ old('rekening_bank', $karyawan->rekening_bank) }}"
                   class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
        ...
        <div class="col-span-2 flex items-center gap-2 pt-1">
            <input type="checkbox" name="is_active" id="is_active" value="1" @checked(old('is_active', $karyawan->is_active))
